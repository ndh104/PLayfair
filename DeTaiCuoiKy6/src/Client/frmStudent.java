            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(50, 50, 50)
                        .addComponent(txtStudentID, javax.swing.GroupLayout.DEFAULT_SIZE, 196, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLabel4)
                        .addGap(55, 55, 55)
                        .addComponent(txtFullName, javax.swing.GroupLayout.DEFAULT_SIZE, 196, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLabel6)
                        .addGap(92, 92, 92)
                        .addComponent(txtSex, javax.swing.GroupLayout.DEFAULT_SIZE, 196, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtMail, javax.swing.GroupLayout.DEFAULT_SIZE, 196, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnSaveAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveAddActionPerformed
        ...
        if (out == 0) {
            try {
                ...
                DBAccess.addStudent(studebtID, fullName, sex, phoneNumber, mail, address);
                DefaultTableModel tbModel = (DefaultTableModel) tb_Student.getModel();
                tbModel.setRowCount(0);
                show_Student();
                btnSaveAdd.setVisible(false);
    ...
    private void btnSaveEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveEditActionPerformed
        ...
        if (out == 0) {
            try {
                ...
                String mail = txtMail.getText();
                String address = txtAddress.getText();
                DBAccess.editStudent(teacherID, fullName, sex, phoneNumber, mail, address);
                DefaultTableModel tbModel = (DefaultTableModel) tb_Student.getModel();
                tbModel.setRowCount(0);
                show_Student();
                btnSaveEdit.setVisible(false);
